const gettime = {
	...
	getChatTime(v1,v2){
		v1=v1.toString().length<13 ? v1*1000 : parseInt(v1);
		v2=v2.toString().length<13 ? v2*1000 : parseInt(v2);
	...
	// 人性化时间格式
	gettime(shorttime){
		shorttime=shorttime.toString().length<13 ? shorttime*1000 : parseInt(shorttime);
